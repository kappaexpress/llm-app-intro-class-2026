...
- **2026年5月 (今)**: ChatGPT は週次9億ユーザー規模、モデルは半年ごとに更新
...
- 従来: 質問を受けたら即座にトークンを吐き出す
- 最近: **裏で思考プロセスを回してから** 最終答えを出す
- 数学・論理・複雑な計画立てで標準モデルより精度が大幅アップ
- 各社にラインナップがある:
  - OpenAI: GPT-5 Thinking / `reasoning_effort` パラメータ
  - Anthropic: Claude の Extended Thinking
  - Google: Gemini 3.1 の Thinking / Deep Think
...
- 本コースで使う `gpt-5.4-nano` も Reasoning 対応
  ...
  - **第4回** で APIから体感、**第8回** で会話ごとの使い分けを実演
